; improved version of ex5!!! takes advantage of interrupt 
; and does things way more efficient.
; f.e. index incrementation occur in play_sound instead of
; in interrupt.
; NOTE: HOWEVER, IT ONLY INCLUDES THE FORWARD DIRECTION ATM.
...
init ; init ports and peripherals
	...
	MOV TIM2_CCER1,#%00000001 ; high-cycle disabled 
...
set_tone_values
	; fetch ARR of tone to play via index
	ldw X, index
